...
<body style="background-image: url({{ url('img/flowerBg.png') }})" class=" bg-center bg-fixed font-montserrat"
    onload="load()">
    ...
    <div class="flex items-center justify-center mx-auto px-6 py-10 mt-24">
        <div
            class=" bg-[#f6a192] drop-shadow-[0_15px_15px_rgba(0,0,0,0.3)] w-5/6 md:w-2/3 lg:w-1/2 xl:w-1/3 rounded-xl py-5 px-10">
            ...
            <form method="POST" action="/register" class=" space-y-4">
                ...
                <div>
                    ...
                    <select name="jenjang" id="jenjang" onchange="change()"
                        class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                ...
                <div>
                    <label for="" class="block mb-2">Lomba</label>
                    <select name="lomba" id="lomba"
                        class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </select>
                </div>
                <button type="submit" class=" bg-[#F5C390] rounded-md w-full p-1 hov">Registrasi</button>
            </form>
        </div>
    </div>
